...
const routes: Routes = [
  ...
  },
  {
    path: "editar-perfil",
    loadChildren: () =>
      import("./editar-perfil/editar-perfil.module").then((m) => m.EditarPerfilPageModule), canActivate: [AuthGuard]
  },
  {
    path: "login",
    loadChildren: () =>
  ...
  },
  {
    path: "historial",
    loadChildren: () =>
      import("./historial/historial.module").then((m) => m.HistorialPageModule), canActivate: [AuthGuard]
  },
  {
    path: 'info-articulo/:id',
    loadChildren: () => import('./info-articulo/info-articulo.module').then(m => m.InfoArticuloPageModule), canActivate: [AuthGuard]
  },
  {
    path: "bienvenida",
    loadChildren: () =>
  ...
  },
  {
    path: "subir-articulo",
    loadChildren: () =>
      import("./subir-articulo/subir-articulo.module").then((m) => m.SubirArticuloPageModule), canActivate: [AuthGuard]
  },
  {
    path: 'chat/:id',
